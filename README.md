...
1. 所有名下没有open状态的问题（无论是自己发起的面试题还是被点名的面试题）的九部成员，都可以点名某九部成员回答某个面试题。

2. 非九部成员，只能点名自己，回答某个面试题（自己回答一个面试题后，则意味着完成 [编号任务](https://github.com/frontend9/fe9-library/blob/master/JOINUS.md)，拥有了成为九部成员的资格）
